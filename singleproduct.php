			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-5 col-md-push-2">
						<div id="product-main-img">
							<div class="product-preview" ng-repeat="img in singleproduct.images">
								<img src="http://192.168.0.104/shopcart/img/products/{{img}}" alt="">
							</div>
						</div>
					</div>
					<!-- /Product main img -->
					...
					<div class="col-md-2  col-md-pull-5">
						<div id="product-img">
							<div class="product-preview" ng-repeat="img in singleproduct.images">
								<img src="http://192.168.0.104/shopcart/img/products/{{img}}" width="100"  height="100" alt="">
							</div>	
						</div>
					</div>
					<!-- /Product thumb imgs -->
					...
					<div class="col-md-5">
						<div class="product-details">
							...
							<div>
								<h3 class="product-price">{{singleproduct.discount_price}} <del class="product-old-price">{{singleproduct.price}}</del></h3>
