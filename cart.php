        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody ng-if="cartdetails.length > 0">
                            <tr ng-repeat="cart in cartdetails">
                                <td>{{$index+1}}</td>
                                <td>
                                    <img src="http://localhost/shopcart/img/products/{{cart.image}}" width="30"
                                        style="float:left;">
                                    <p> {{cart.title}}</p>
                                </td>
                    ...
                    <div class="col-sm-12"  ng-if="cartdetails.length > 0">
                        <a href="checkout.php"
                            class="btn btn-success btn-lg pull-right">Buy Now</a>
                    </div>
